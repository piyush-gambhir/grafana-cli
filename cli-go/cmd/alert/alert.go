...
import (
	...
	"github.com/piyush-gambhir/grafana-cli/cli-go/cmd/alert/contactpoint"
	"github.com/piyush-gambhir/grafana-cli/cli-go/cmd/alert/mutetiming"
	"github.com/piyush-gambhir/grafana-cli/cli-go/cmd/alert/policy"
	"github.com/piyush-gambhir/grafana-cli/cli-go/cmd/alert/rule"
	"github.com/piyush-gambhir/grafana-cli/cli-go/cmd/alert/silence"
	"github.com/piyush-gambhir/grafana-cli/cli-go/cmd/alert/template"
